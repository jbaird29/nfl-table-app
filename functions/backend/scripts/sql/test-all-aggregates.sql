SELECT
    ...
    SUM(CASE WHEN true AND (pass_was_on_target = 1) THEN pass_was_attempt ELSE NULL END) AS pass_on_target_sum,
    100 * SUM(CASE WHEN true AND (pass_was_on_target = 1) THEN pass_was_attempt ELSE NULL END) / SUM(CASE WHEN true THEN pass_was_attempt  ELSE NULL END) AS pass_on_target_percentage,
